    ...
    <div className="flex items-center justify-center mb-4 sm:mb-6 px-2">
      {[
        ...
        <div key={s.num} className="flex items-center">
          <div className={`flex flex-col items-center relative z-10 ${step >= s.num ? 'text-purple-700' : 'text-gray-300'}`}>
            <div className={`w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center font-bold border-2 transition-all duration-300 ${
              step >= s.num ? 'bg-purple-100 border-purple-600 text-purple-700' : 'bg-white border-gray-200'
            }`}>
          ...
          {index < 3 && <div className={`w-6 sm:w-12 h-1 mx-1 sm:mx-2 -mt-4 sm:-mt-6 transition-all duration-500 ${step > s.num ? 'bg-purple-600' : 'bg-gray-200'}`} />}
        </div>
      ))}
    </div>
  );
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="bg-white p-4 sm:p-6 md:p-8 rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        {step === 2 && (
          <div className="space-y-4 animate-fadeIn">
            ...
            <div className="bg-purple-50 p-3 sm:p-4 rounded-lg border border-purple-100 mb-4">
              <h4 className="font-bold text-purple-800 text-sm mb-2 sm:mb-3 flex items-center gap-2">
                <GraduationCap size={14} className="sm:size-[16px]"/> Registro de Classe
              </h4>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                <div>
                  <label className="label text-purple-900">Tipo de Conselho *</label>
                  <select 
                    {...register("conselho_tipo", { required: "Tipo de conselho é obrigatório" })} 
                    className={`${getInputClass("conselho_tipo")} border-purple-200`}
                  >
                    <option value="">Selecione...</option>
                ...
                <div>
                  <label className="label text-purple-900">Número *</label>
                  <input 
                    ...
                    className={`${getInputClass("conselho_numero")} border-purple-200`}
                    placeholder="Ex: 123456"
                  />
                  <ErrorMessage error={errors.conselho_numero} />
                </div>
                <div>
                  <label className="label text-purple-900">UF *</label>


                  
                  <select 
                    {...register("conselho_uf", { required: "UF do conselho é obrigatória" })} 
                    className={`${getInputClass("conselho_uf")} border-purple-200`}
                  >
        ...
        {step === 4 && (
          <div className="animate-fadeIn">
            <div className="bg-purple-50 border border-purple-200 rounded-xl p-4 sm:p-6 mb-4 sm:mb-6 text-center">
              <div className="w-12 h-12 sm:w-16 sm:h-16 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-3 text-purple-600">
            ...
            <div className="bg-gray-50 p-3 sm:p-4 rounded-lg border border-gray-200 mb-4 relative">
              <div className="flex justify-between items-center mb-2 sm:mb-3">
                ...
                <button 
                  type="button"
                  onClick={() => goToStep(1)}
                  className="flex items-center gap-1 text-xs sm:text-sm text-purple-600 hover:text-purple-800 bg-purple-50 hover:bg-purple-100 px-2 sm:px-3 py-1 rounded-full transition-colors"
                >
        ...
        <div className="flex flex-col sm:flex-row justify-between mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-gray-100 gap-3 sm:gap-4">
          ...
          {step < 4 ? (
            <button 
              ...
              className="flex items-center justify-center gap-2 px-4 sm:px-6 py-2 sm:py-3 rounded-lg bg-conectiva-navy text-white hover:bg-slate-800 shadow-lg w-full sm:w-auto text-sm sm:text-base"
            >
            ...
            <div className="w-full flex flex-col sm:flex-row justify-end gap-3 sm:gap-4">
              ...
              <button 
                ...
                className="flex items-center justify-center gap-2 px-6 sm:px-8 py-2 sm:py-3 rounded-lg bg-purple-600 text-white font-bold hover:bg-purple-700 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed transition-colors w-full sm:w-auto text-sm sm:text-base"
              >
